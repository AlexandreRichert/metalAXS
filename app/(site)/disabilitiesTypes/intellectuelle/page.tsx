...
export default function IntellectuelleDisabilityPage() {
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col lg:flex-row gap-8 items-center">
                        ...
                        <div className="w-full lg:w-1/2">
                            <h1 >
                                Déficience <Highlight>Intellectuelle</Highlight>
                            </h1>

                            <p className="leading-relaxed">Les personnes atteintes de déficience intellectuelle ont un quotient intellectuel très inférieur à la moyenne. </p>
                            <p className="leading-relaxed">Elles sont officiellement 700 000 en France. Elles peuvent éprouver des difficultés à mobiliser leur attention, à maîtriser le calcul et le raisonnement, à comprendre les informations et, par conséquent, à s'adapter ou à se repérer dans un environnement inconnu.</p>
                            <p className="leading-relaxed">Elles ont besoin de repères simples : symboles graphiques, couleurs claires, signalétique répétitive.</p>

                        </div>
                        <div className="w-full lg:w-1/2">
                            <img
                                src="/disable.jpg"
                                alt="Déficience intellectuelle"
                    ...
                    <div className="flex flex-col-reverse lg:flex-row gap-8 items-center">
                        ...
                        <div className="w-full lg:w-1/2">
                            ...
                            <p className="leading-relaxed">
                                Sur un festival, les personnes en situation de déficience intellectuelle expriment plusieurs besoins :
                            </p>
