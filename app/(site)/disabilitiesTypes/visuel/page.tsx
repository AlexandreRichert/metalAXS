...
export default function VisualDisabilityPage() {
    ...
    const cards: Card[] = [
        {
            id: 1,
            image: "/disable.jpg",
            title: "Site et supports digitaux accessibles",
        ...
        },
        {
            id: 2,
            image: "/disable.jpg",
            title: "Informations orales",
            description: "Lorem ipsum dolor sit amet consectetur. Diam maecenas dignissim proin quam tincidunt sapien sit. Ut neque ultricies elementum nec sapien donec lacus. Eget est massa id arcu suspendisse fermentum sit egestas sed. Lectus in vel tempor netus accumsan facilisis. Placerat urna eros hendrerit vel turpis pretium. Nisl dictum eu egestas pellentesque adipiscing tincidunt. Et bibendum velit pellentesque facilisi donec congue amet orci. Posuere in ut semper quam pharetra at purus scelerisque. Orci turpis elementum urna dolor fringilla quam tempor egestas. Nisl in duis cras vitae a adipiscing. Imperdiet augue pellentesque elementum mi.",
        },
        {
            id: 3,
            image: "/disable.jpg",
            title: "Cheminement dégagé",
            description: "Lorem ipsum dolor sit amet consectetur. Diam maecenas dignissim proin quam tincidunt sapien sit. Ut neque ultricies elementum nec sapien donec lacus. Eget est massa id arcu suspendisse fermentum sit egestas sed. Lectus in vel tempor netus accumsan facilisis. Placerat urna eros hendrerit vel turpis pretium. Nisl dictum eu egestas pellentesque adipiscing tincidunt. Et bibendum velit pellentesque facilisi donec congue amet orci. Posuere in ut semper quam pharetra at purus scelerisque. Orci turpis elementum urna dolor fringilla quam tempor egestas. Nisl in duis cras vitae a adipiscing. Imperdiet augue pellentesque elementum mi.",
        },
        {
            id: 4,
            image: "/disable.jpg",
            title: "Mains courantes en braille",
            description: "Lorem ipsum dolor sit amet consectetur. Diam maecenas dignissim proin quam tincidunt sapien sit. Ut neque ultricies elementum nec sapien donec lacus. Eget est massa id arcu suspendisse fermentum sit egestas sed. Lectus in vel tempor netus accumsan facilisis. Placerat urna eros hendrerit vel turpis pretium. Nisl dictum eu egestas pellentesque adipiscing tincidunt. Et bibendum velit pellentesque facilisi donec congue amet orci. Posuere in ut semper quam pharetra at purus scelerisque. Orci turpis elementum urna dolor fringilla quam tempor egestas. Nisl in duis cras vitae a adipiscing. Imperdiet augue pellentesque elementum mi.",
        },
        {
            id: 5,
            image: "/disable.jpg",
            title: "Guidage au sol",
            description: "Lorem ipsum dolor sit amet consectetur. Diam maecenas dignissim proin quam tincidunt sapien sit. Ut neque ultricies elementum nec sapien donec lacus. Eget est massa id arcu suspendisse fermentum sit egestas sed. Lectus in vel tempor netus accumsan facilisis. Placerat urna eros hendrerit vel turpis pretium. Nisl dictum eu egestas pellentesque adipiscing tincidunt. Et bibendum velit pellentesque facilisi donec congue amet orci. Posuere in ut semper quam pharetra at purus scelerisque. Orci turpis elementum urna dolor fringilla quam tempor egestas. Nisl in duis cras vitae a adipiscing. Imperdiet augue pellentesque elementum mi.",
        },
        {
            id: 6,
            image: "/disable.jpg",
            title: "Siganlétique contrastée",
            description: "Lorem ipsum dolor sit amet consectetur. Diam maecenas dignissim proin quam tincidunt sapien sit. Ut neque ultricies elementum nec sapien donec lacus. Eget est massa id arcu suspendisse fermentum sit egestas sed. Lectus in vel tempor netus accumsan facilisis. Placerat urna eros hendrerit vel turpis pretium. Nisl dictum eu egestas pellentesque adipiscing tincidunt. Et bibendum velit pellentesque facilisi donec congue amet orci. Posuere in ut semper quam pharetra at purus scelerisque. Orci turpis elementum urna dolor fringilla quam tempor egestas. Nisl in duis cras vitae a adipiscing. Imperdiet augue pellentesque elementum mi.",
        },
        {
            id: 7,
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col lg:flex-row gap-8 items-center">
                        ...
                        <div className="w-full lg:w-1/2">
                            <h1 >
                                Handicap <Highlight>Visuel</Highlight>
                            </h1>

                            <p className="leading-relaxed">L’handicap visuel couvre un champ extrêmement large. Il touche officiellement 1,3 million de personnes en France, dont seulement 2 à 3 % de personnes non-voyantes.</p>
                            <p className="leading-relaxed">Certaines ont une acuité visuelle très faible, ne distinguent pas les couleurs, manquent de vision périphérique ou frontale, ou ne perçoivent que les contrastes lumineux. </p>
                            <p className="leading-relaxed">Parmi elles, 7 à 8 000 personnes utilisent le Braille. Pour s'orienter, ces personnes s'appuient sur la vision qui leur reste et sur des repères environnementaux : textures, couleurs contrastées, odeurs, sons.</p>

                        </div>
                        <div className="w-full lg:w-1/2">
                            <img
                                src="/disable.jpg"
                                alt="Handicaps visuels"
                    ...
                    <div className="flex flex-col-reverse lg:flex-row gap-8 items-center">
                        ...
                        <div className="w-full lg:w-1/2">
                            ...
                            <p className="leading-relaxed">
                                Sur un festival, les personnes en situation de handicap visuel expriment plusieurs besoins :
                            </p>
