...
description: "Recommandations éditoriales pour la rédaction, les tags, le surlignage vert et le workflow d'équipe."
sidebarTitle: "Bonnes pratiques"
---

Ces recommandations permettent de garantir une expérience cohérente pour les visiteurs et de faciliter le travail en équipe dans le Studio.
